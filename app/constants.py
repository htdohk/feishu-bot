...
SYSTEM_PROMPT_SUMMARY = "你是擅长做会议/群聊总结的助理。"

SYSTEM_PROMPT_WELCOME = "你是友好的群聊助手，擅长写欢迎语。"
...
PROMPT_TEMPLATE_SUMMARY = (
    "请对以下群聊做{period}总结：\n"
    "- 输出：主题Top N、关键结论/决定、待办与负责人、参考链接/原话片段、活跃度与情绪（可选）。\n"
    "- 语气客观，条理清晰。\n\n"
    "片段：\n{messages}"
)

PROMPT_TEMPLATE_WELCOME = (
    "为新成员写一段40~80字的欢迎语，并附上过去两周群里讨论的主题关键词与一个开场建议。\n"
    "上下文示例：\n{context}"
)
